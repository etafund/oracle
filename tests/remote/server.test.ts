...
describe("remote browser service", () => {
  ...
  test.skipIf(!CAN_LISTEN_LOCALHOST)(
    ...
    async () => {
            ...
            const result: BrowserRunResult = {
              ...
              warnings: [
                ...
                },
                {
                  code: "chatgpt-ui-warning",
                  severity: "warning",
                  message: "host-only warning open '/Users/private/file.zip'",
                },
                {
                  code: "chatgpt-ui-warning",
                  severity: "warning",
                  message: "host-only warning file:///tmp/private.zip",
                },
                {
                  code: "chatgpt-ui-warning",
                  severity: "warning",
                  message: "host-only warning (/mnt/c/Users/private/file.zip)",
                },
              ],
            };
            return result;
      ...
      expect(JSON.stringify(result)).not.toContain("open '/Users/private/file.zip'");
      expect(JSON.stringify(result)).not.toContain("file:///tmp/private.zip");
      expect(JSON.stringify(result)).not.toContain("/mnt/c/Users/private/file.zip");
